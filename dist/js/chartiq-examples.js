(window.webpackJsonp=window.webpackJsonp||[]).push([[2],[,,function(e,t,a){"use strict";var o,r=a(1);"undefined"==typeof define&&"object"==typeof e?o=a(18):"function"==typeof define&&a(4)?define(["../../examples/markers/markersSample.css"],(function(e){o=e})):"undefined"!=typeof window&&r.c.loadStylesheet("examples/markers/markersSample.css"),o&&r.c.addInternalStylesheet(o,"markersSample.css"),r.c.activateImports(r.f);var n=function(e){this.stx=e,this.activeLabels=[]};n.specialTypes={},n.registerType=function(e,t,a){!this.specialTypes[e]||a?this.specialTypes[e]=t:console.error("ERROR: failed to register event type "+e+". Event already registered")},n.prototype.processLabelsAndDraw=function(e){return this.activeLabels=this.activeLabels.concat(e),this.stx.draw(),e},n.prototype.createMarkers=function(e,t){var a=this.stx,o=a.chart.dataSet,n=a.tickFromDate(a.chart.endPoints.end),s=[];if(t||(t="Simple"),o){n>=5&&s.push({x:o[n-5].DT,type:e,category:"news",headline:"This is a Marker for a News Item"}),n>=15&&s.push({x:o[n-15].DT,type:e,category:"earningsUp",headline:"This is a Marker for Earnings (+)"}),n>=25&&s.push({x:o[n-25].DT,type:e,category:"earningsDown",headline:"This is a Marker for Earnings (-)"}),n>=35&&s.push({x:o[n-35].DT,type:e,category:"dividend",headline:"This is a Marker for Dividends"}),n>=45&&s.push({x:o[n-45].DT,type:e,category:"filing",headline:"This is a Marker for a Filing"}),n>=55&&s.push({x:o[n-55].DT,type:e,category:"split",headline:"This is a Marker for a Split"});for(var d=0;d<s.length;d++){var c=s[d];c.story="Like all ChartIQ markers, the object itself is managed by the chart, so when you scroll the chart the object moves with you. It is also destroyed automatically for you when the symbol is changed.",new r.c.Marker({stx:a,label:e,xPositioner:"date",x:c.x,node:new r.c.Marker[t](c)})}return e}},n.prototype.createAbstractMarker=function(e){var t=this.stx,a=document.querySelector(".stx-marker-templates").querySelector(".stx-marker.abstract").cloneNode(!0);return Object.assign(a.style,{"z-index":30,left:(.4*t.chart.width).toString()+"px"}),new r.c.Marker({stx:t,xPositioner:"none",yPositioner:"above_candle",label:e,permanent:!0,chartContainer:!0,node:a}),e},n.prototype.hideMarkers=function(){var e=this.stx;this.activeLabels.forEach((function(t){r.c.Marker.removeByLabel(e,t)})),this.activeLabels=[]},n.prototype.showMarkers=function(e,t){if(!e)return this.hideMarkers();var a=n.specialTypes[e];return a?this.processLabelsAndDraw(this[a](e,t)):"abstract"===e?this.processLabelsAndDraw(this.createAbstractMarker("helicopter")):this.processLabelsAndDraw(this.createMarkers(e,t))};let s={MarkersSample:n};t.a=s},,,,,function(e,t,a){"use strict";var o=a(0),r={valids:["FOR","FF","FTFT","AIQ","EURCHF"],periodsBack:50,periodsForward:50,randomizationFactor:.3,spreadPercentage:.05,certaintyPercentages:[.35,.15,.08,.05,.02,.01,.01],generateData:function(e,t,a,n){if(e.chart.masterData&&e.chart.masterData.length){if(-1==r.valids.indexOf(t))return null;var s,d;if(t==e.chart.symbol)s=e.chart.endPoints;else for(var c in e.chart.series)t==e.chart.series[c].parameters.symbol&&(d=!0,s=e.chart.series[t].endPoints);if(s){var i,l={begin:s.end,interval:a,periodicity:n},p=new o.c.Market(o.c.Market.Symbology.factory({symbol:t})),m=p.newIterator(l);for(m.previous(r.periodsBack*e.layout.periodicity),i=e.chart.masterData.length-1;i>=0&&!(e.chart.masterData[i].DT<=m.begin);i--);i<0&&(i=0);for(var y,u,h,f=e.chart.masterData[i];i<e.chart.masterData.length&&(u=(y=e.chart.masterData[i]).DT,h=y.Volume,!(y&&(d&&(y=y[t]),y&&("object"==typeof y&&(h=y.Volume,y=y.Close),y||0===y))));)i++;y||0===y||(y=f.Close,u=f.DT,h=f.Volume);var k=r.randomizationFactor,g=2;Math.abs(y)<2&&(g=4,k/=100);for(var b=[],w=(r.periodsBack+r.periodsForward)*e.layout.periodicity;b.length<w;){var v,S=b[b.length-1];if(S){(v={DT:m.next(),Close:Number(((Math.random()-.5)*k+S.Close).toFixed(g)),Open:Number(S.Close),Volume:S.Volume*(1+(Math.random()-.5)/10),Certainty:[]}).High=v.Close*(1+r.spreadPercentage*b.length/w),v.Low=v.Close*(1-r.spreadPercentage*b.length/w);for(var x=r.certaintyPercentages.length,M=0;M<x;M++){var D=r.certaintyPercentages[M];M?(v.Certainty.push([v.Close+M/(x-1)*(v.High-v.Close),null,D]),v.Certainty.push([v.Close+M/(x-1)*(v.Low-v.Close),null,D])):v.Certainty.push([v.Close,null,D])}}else v={DT:u,Close:y,High:y,Low:y,Open:y,Volume:h},l.begin=u,m=p.newIterator(l);b.push(v)}return b}}},fetchInitialData:function(e,t,a,o,n){var s=r.generateData(o.stx,e,o.interval,o.period);n(s?{quotes:s,moreAvailable:!1,attribution:{source:"forecaster",exchange:"RANDOM"}}:{error:"Not found"})},fetchUpdateData:function(e,t,a,o){var n=r.generateData(a.stx,e,a.interval,a.period);o(n?{quotes:n,moreAvailable:!1,attribution:{source:"forecaster",exchange:"RANDOM"}}:{error:"Not found"})},fetchPaginationData:function(e,t,a,o,n){var s=r.generateData(o.stx,e,o.interval,o.period);n(s?{quotes:s,moreAvailable:!1,attribution:{source:"forecaster",exchange:"RANDOM"}}:{error:"Not found"})}};t.a=r},,,,,,,function(e,t,a){"use strict"},function(e,t,a){"use strict";var o=a(1);o.c.activateImports(o.g,o.h),o.c.ChartEngine.Driver.Lookup.ChartIQ=function(e){this.exchanges=e,this.exchanges||(this.exchanges=["XNYS","XASE","XNAS","XASX","INDCBSX","INDXASE","INDXNAS","IND_DJI","ARCX","INDARCX","forex","mutualfund","futures"]),this.url="https://symbols.chartiq.com/chiq.symbolserver.SymbolLookup.service",this.requestCounter=0},o.c.inheritsFrom(o.c.ChartEngine.Driver.Lookup.ChartIQ,o.c.ChartEngine.Driver.Lookup),o.c.ChartEngine.Driver.Lookup.ChartIQ.prototype.acceptText=function(e,t,a,r){"FX"==t&&(t="FOREX"),isNaN(parseInt(a,10))&&(a=100);var n=this.url+"?t="+encodeURIComponent(e)+"&m="+a+"&x=[";this.exchanges&&(n+=this.exchanges.join(",")),n+="]",t&&"ALL"!=t.toUpperCase()&&(n+="&e="+t);var s=++this.requestCounter,d=this;o.c.postAjax({url:n,cb:function(e,t){if(!(s<d.requestCounter)&&200==e)try{for(var a=(t=JSON.parse(t)).payload.symbols,o=[],n=0;n<a.length;n++){var c=a[n].split("|"),i={symbol:c[0],name:c[1],exchDisp:c[2]};o.push({display:[i.symbol,i.name,i.exchDisp],data:i})}r(o)}catch(e){}}})}},function(e,t,a){"use strict";var o=a(0);o.c.Market=o.c.Market||function(){},o.c.Market.GLOBEX={name:"GLOBEX",market_tz:"America/Chicago",hour_aligned:!0,normal_daily_open:"00:00",normal_daily_close:"24:00",rules:[{dayofweek:0,open:"15:00",close:"24:00"},{dayofweek:1,open:"00:00",close:"24:00"},{dayofweek:2,open:"00:00",close:"24:00"},{dayofweek:3,open:"00:00",close:"24:00"},{dayofweek:4,open:"00:00",close:"24:00"},{dayofweek:5,open:"00:00",close:"18:00"}]},o.c.Market.FOREX={name:"FOREX",market_tz:"America/New_York",hour_aligned:!0,normal_daily_open:"17:00",normal_daily_close:"17:00",rules:[{dayofweek:0,open:"15:00",close:"17:00"},{dayofweek:0,open:"17:00",close:"24:00"},{dayofweek:1,open:"00:00",close:"17:00"},{dayofweek:1,open:"17:00",close:"24:00"},{dayofweek:2,open:"00:00",close:"17:00"},{dayofweek:2,open:"17:00",close:"24:00"},{dayofweek:3,open:"00:00",close:"17:00"},{dayofweek:3,open:"17:00",close:"24:00"},{dayofweek:4,open:"00:00",close:"17:00"},{dayofweek:4,open:"17:00",close:"24:00"},{dayofweek:5,open:"00:00",close:"17:00"}]},o.c.Market.METALS={name:"METALS",market_tz:"America/New_York",hour_aligned:!0,normal_daily_open:"18:00",normal_daily_close:"17:15",rules:[{dayofweek:0,open:"18:00",close:"24:00"},{dayofweek:1,open:"00:00",close:"17:15"},{dayofweek:1,open:"18:00",close:"24:00"},{dayofweek:2,open:"00:00",close:"17:15"},{dayofweek:2,open:"18:00",close:"24:00"},{dayofweek:3,open:"00:00",close:"17:15"},{dayofweek:3,open:"18:00",close:"24:00"},{dayofweek:4,open:"00:00",close:"17:15"},{dayofweek:4,open:"18:00",close:"24:00"},{dayofweek:5,open:"00:00",close:"17:15"}]},o.c.Market.NYSE={name:"NYSE",market_tz:"America/New_York",hour_aligned:!1,normal_daily_open:"09:30",normal_daily_close:"16:00",rules:[{dayofweek:1,open:"09:30",close:"16:00"},{dayofweek:2,open:"09:30",close:"16:00"},{dayofweek:3,open:"09:30",close:"16:00"},{dayofweek:4,open:"09:30",close:"16:00"},{dayofweek:5,open:"09:30",close:"16:00"},{dayofweek:1,open:"04:00",close:"09:30",name:"pre"},{dayofweek:2,open:"04:00",close:"09:30",name:"pre"},{dayofweek:3,open:"04:00",close:"09:30",name:"pre"},{dayofweek:4,open:"04:00",close:"09:30",name:"pre"},{dayofweek:5,open:"04:00",close:"09:30",name:"pre"},{dayofweek:1,open:"16:00",close:"20:00",name:"post"},{dayofweek:2,open:"16:00",close:"20:00",name:"post"},{dayofweek:3,open:"16:00",close:"20:00",name:"post"},{dayofweek:4,open:"16:00",close:"20:00",name:"post"},{dayofweek:5,open:"16:00",close:"20:00",name:"post"},{date:"*-12-25",open:"00:00",close:"00:00"},{date:"*-07-04",open:"00:00",close:"00:00"},{date:"*-01-01",open:"00:00",close:"00:00"},{date:"2012-01-02",open:"00:00",close:"00:00"},{date:"2021-01-18"},{date:"2021-02-15"},{date:"2021-04-02"},{date:"2021-05-31"},{date:"2021-07-05"},{date:"2021-09-06"},{date:"2021-11-25"},{date:"2021-11-26",open:"4:00",close:"9:30",name:"pre"},{date:"2021-11-26",open:"9:30",close:"13:00"},{date:"2021-12-24"},{date:"2020-01-20"},{date:"2020-02-17"},{date:"2020-04-10"},{date:"2020-05-25"},{date:"2020-07-03"},{date:"2020-09-07"},{date:"2020-11-26"},{date:"2020-11-27",open:"4:00",close:"9:30",name:"pre"},{date:"2020-11-27",open:"9:30",close:"13:00"},{date:"2020-12-24",open:"4:00",close:"9:30",name:"pre"},{date:"2020-12-24",open:"9:30",close:"13:00"},{date:"2019-01-21"},{date:"2019-02-18"},{date:"2019-04-19"},{date:"2019-05-27"},{date:"2019-07-03",open:"4:00",close:"9:30",name:"pre"},{date:"2019-07-03",open:"9:30",close:"13:00"},{date:"2019-09-02"},{date:"2019-11-28"},{date:"2019-11-29",open:"4:00",close:"9:30",name:"pre"},{date:"2019-11-29",open:"9:30",close:"13:00"},{date:"2019-12-24",open:"4:00",close:"9:30",name:"pre"},{date:"2019-12-24",open:"9:30",close:"13:00"},{date:"2018-01-15"},{date:"2018-02-19"},{date:"2018-03-30"},{date:"2018-05-28"},{date:"2018-07-03",open:"4:00",close:"9:30",name:"pre"},{date:"2018-07-03",open:"9:30",close:"13:00"},{date:"2018-09-03"},{date:"2018-11-22"},{date:"2018-11-23",open:"4:00",close:"9:30",name:"pre"},{date:"2018-11-23",open:"9:30",close:"13:00"},{date:"2018-12-05"},{date:"2018-12-24",open:"4:00",close:"9:30",name:"pre"},{date:"2018-12-24",open:"9:30",close:"13:00"},{date:"2017-01-02"},{date:"2017-01-16"},{date:"2017-02-20"},{date:"2017-04-14"},{date:"2017-05-29"},{date:"2017-07-03",open:"4:00",close:"9:30",name:"pre"},{date:"2017-07-03",open:"9:30",close:"13:00"},{date:"2017-09-04"},{date:"2017-11-23"},{date:"2017-11-24",open:"4:00",close:"9:30",name:"pre"},{date:"2017-11-24",open:"9:30",close:"13:00"},{date:"2016-01-18"},{date:"2016-02-15"},{date:"2016-03-25"},{date:"2016-05-30"},{date:"2016-09-05"},{date:"2016-11-24"},{date:"2016-11-25",open:"4:00",close:"9:30",name:"pre"},{date:"2016-11-25",open:"9:30",close:"13:00"},{date:"2016-12-26"},{date:"2015-01-19"},{date:"2015-02-16"},{date:"2015-04-03"},{date:"2015-05-25"},{date:"2015-07-03"},{date:"2015-09-07"},{date:"2015-11-26"},{date:"2015-11-27",open:"4:00",close:"9:30",name:"pre"},{date:"2015-11-27",open:"9:30",close:"13:00"},{date:"2015-12-24",open:"4:00",close:"9:30",name:"pre"},{date:"2015-12-24",open:"9:30",close:"13:00"},{date:"2014-01-20"},{date:"2014-02-17"},{date:"2014-04-18"},{date:"2014-05-26"},{date:"2014-09-01"},{date:"2014-11-27"},{date:"2014-07-03",open:"4:00",close:"9:30",name:"pre"},{date:"2014-07-03",open:"9:30",close:"13:00"},{date:"2014-11-28",open:"4:00",close:"9:30",name:"pre"},{date:"2014-11-28",open:"9:30",close:"13:00"},{date:"2014-12-24",open:"4:00",close:"9:30",name:"pre"},{date:"2014-12-24",open:"9:30",close:"13:00"},{date:"2013-01-21"},{date:"2013-02-18"},{date:"2013-03-29"},{date:"2013-05-27"},{date:"2013-09-02"},{date:"2013-11-28"},{date:"2013-07-03",open:"4:00",close:"9:30",name:"pre"},{date:"2013-07-03",open:"9:30",close:"13:00"},{date:"2013-11-29",open:"4:00",close:"9:30",name:"pre"},{date:"2013-11-29",open:"9:30",close:"13:00"},{date:"2013-12-24",open:"4:00",close:"9:30",name:"pre"},{date:"2013-12-24",open:"9:30",close:"13:00"},{date:"2012-01-16"},{date:"2012-02-20"},{date:"2012-04-06"},{date:"2012-05-28"},{date:"2012-09-03"},{date:"2012-10-29"},{date:"2012-10-30"},{date:"2012-11-22"},{date:"2012-07-03",open:"4:00",close:"9:30",name:"pre"},{date:"2012-07-03",open:"9:30",close:"13:00"},{date:"2012-11-23",open:"4:00",close:"9:30",name:"pre"},{date:"2012-11-23",open:"9:30",close:"13:00"},{date:"2012-12-24",open:"4:00",close:"9:30",name:"pre"},{date:"2012-12-24",open:"9:30",close:"13:00"}]},o.c.Market.LSE={name:"London",market_tz:"Europe/London",hour_aligned:!1,normal_daily_open:"08:00",normal_daily_close:"17:00",rules:[{dayofweek:1,open:"08:00",close:"17:00"},{dayofweek:2,open:"08:00",close:"17:00"},{dayofweek:3,open:"08:00",close:"17:00"},{dayofweek:4,open:"08:00",close:"17:00"},{dayofweek:5,open:"08:00",close:"17:00"},{date:"*-12-25",open:"00:00",close:"00:00"},{date:"*-12-26",open:"00:00",close:"00:00"},{date:"*-01-01",open:"00:00",close:"00:00"},{date:"2012-01-02",open:"00:00",close:"00:00"},{date:"2021-04-02"},{date:"2021-04-05"},{date:"2021-05-03"},{date:"2021-05-31"},{date:"2021-08-30"},{date:"2021-12-24",open:"8:00",close:"12:30"},{date:"2021-12-27"},{date:"2021-12-28"},{date:"2021-12-31",open:"8:00",close:"12:30"},{date:"2020-04-10"},{date:"2020-04-13"},{date:"2020-05-04"},{date:"2020-05-25"},{date:"2020-08-31"},{date:"2020-12-24",open:"8:00",close:"12:30"},{date:"2020-12-28"},{date:"2020-12-31",open:"8:00",close:"12:30"},{date:"2019-04-19"},{date:"2019-04-22"},{date:"2019-05-06"},{date:"2019-05-27"},{date:"2019-08-26"},{date:"2019-12-24",open:"8:00",close:"12:30"},{date:"2019-12-31",open:"8:00",close:"12:30"},{date:"2018-03-30"},{date:"2018-04-02"},{date:"2018-05-07"},{date:"2018-05-28"},{date:"2018-08-27"},{date:"2018-12-24",open:"8:00",close:"12:30"},{date:"2018-12-31",open:"8:00",close:"12:30"},{date:"2017-01-02"},{date:"2017-04-14"},{date:"2017-04-17"},{date:"2017-05-01"},{date:"2017-05-29"},{date:"2017-08-28"},{date:"2017-12-22",open:"8:00",close:"12:30"},{date:"2017-12-29",open:"8:00",close:"12:30"},{date:"2016-03-25"},{date:"2016-03-28"},{date:"2016-05-02"},{date:"2016-05-30"},{date:"2016-08-29"},{date:"2016-12-23",open:"8:00",close:"12:30"},{date:"2016-12-27"},{date:"2016-12-30",open:"8:00",close:"12:30"},{date:"2015-04-03"},{date:"2015-04-06"},{date:"2015-05-04"},{date:"2015-05-25"},{date:"2015-08-31"},{date:"2015-12-24",open:"8:00",close:"12:30"},{date:"2015-12-28"},{date:"2015-12-31",open:"8:00",close:"12:30"},{date:"2014-04-18"},{date:"2014-04-21"},{date:"2014-05-05"},{date:"2014-05-26"},{date:"2014-08-25"},{date:"2014-12-24",open:"8:00",close:"12:30"},{date:"2014-12-31",open:"8:00",close:"12:30"},{date:"2013-03-29"},{date:"2013-04-01"},{date:"2013-05-06"},{date:"2013-05-27"},{date:"2013-08-26"},{date:"2013-12-24",open:"8:00",close:"12:30"},{date:"2013-12-31",open:"8:00",close:"12:30"},{date:"2012-01-02"},{date:"2012-04-06"},{date:"2012-04-09"},{date:"2012-05-07"},{date:"2012-06-04"},{date:"2012-06-05"},{date:"2012-08-27"},{date:"2012-12-24",open:"8:00",close:"12:30"},{date:"2012-12-31",open:"8:00",close:"12:30"}]}},function(e,t,a){"use strict";var o=a(0);o.c.Market=o.c.Market||function(){},o.c.Market.Symbology=o.c.Market.Symbology||function(){},o.c.Market.Symbology.isForeignSymbol=function(e){return!!e&&-1!=e.indexOf(".")},o.c.Market.Symbology.isFuturesSymbol=function(e){return!!e&&(e.length>1&&"/"==e[0])},o.c.Market.Symbology.isRateSymbol=function(e){return!!e&&(e.length>1&&"%"==e[0])},o.c.Market.Symbology.isForexSymbol=function(e){return!!e&&(!o.c.Market.Symbology.isForeignSymbol(e)&&(!o.c.Market.Symbology.isFuturesSymbol(e)&&(!(e.length<6||e.length>7)&&((6!=e.length||"X"!=e[5])&&!!/\^?[A-Za-z]{6}/.test(e)))))},o.c.Market.Symbology.isForexMetal=function(e,t){var a={XAU:!0,XAG:!0,XPT:!0,XPD:!0};return!!e&&(!!o.c.Market.Symbology.isForexSymbol(e)&&("^"!=e.charAt(0)&&(e="^"+e),!(a[e.substring(1,4)]||!a[e.substring(4,7)])||!(t||!a[e.substring(1,4)]||a[e.substring(4,7)])))},o.c.Market.Symbology.factory=function(e){var t=e.symbol;return o.c.Market.Symbology.isForeignSymbol(t)?null:o.c.Market.Symbology.isFuturesSymbol(t)?o.c.Market.GLOBEX:o.c.Market.Symbology.isForexMetal(t)?o.c.Market.METALS:o.c.Market.Symbology.isForexSymbol(t)?o.c.Market.FOREX:o.c.Market.NYSE},o.c.Market.Symbology.encodeTermStructureInstrumentSymbol=function(e,t){return"%"===e[0]&&(e=e.slice(1)),e+" "+t}},,function(e,t,a){"use strict";var o,r=a(1),n=a(3),s=a(2);"undefined"==typeof define&&"object"==typeof e?o=a(20):"function"==typeof define&&a(4)?define(["../../examples/markers/tradeAnalyticsSample.css"],(function(e){o=e})):"undefined"!=typeof window&&r.c.loadStylesheet("examples/markers/tradeAnalyticsSample.css"),r.c.activateImports(r.f,n.a),o&&r.c.addInternalStylesheet(o,"tradeAnalyticsSample.css"),r.c.activateImports(r.f,n.a);const d=s.a.MarkersSample;d.registerType("trade","showTradeAnalytics"),d.prototype.showTradeAnalytics=function(){let{stx:e}=this,{chart:t}=e,{dataSet:a,dataSegment:o}=t;if(!a.length||!o.length)return;if(!o[10])return;new r.c.Marker({stx:e,label:"callout",xPositioner:"date",x:o[10].DT,node:new r.c.Marker.Simple({type:"callout",headline:"Begin Trade Period",category:"analysis",story:"Starting Price: "+o[10].Close+"\n\t\t\t\t\t\t\tShares: 5000\n\t\t\t\t\t\t\tExchange: "+t.market.market_def.name})});let n=e.tickFromDate(t.endPoints.end,t);return n&&a[n-2]&&a[n-2].DT&&new r.c.Marker({stx:e,label:"callout",xPositioner:"date",x:a[n-2].DT,node:new r.c.Marker.Simple({type:"callout",headline:"End Trade Period",category:"analysis",story:"Ending Price: "+o[o.length-2].Close+"\n\t\t\t\t\t\t\tShares: 5000\n\t\t\t\t\t\t\tExchange: "+t.market.market_def.name})}),this.createTradeMarkers(e),["callout","trade"]},d.prototype.createTradeMarkers=function(){const e=this.stx.chart.dataSegment;for(let t=e.length-3;t>10;t-=2){let a=e[t];new r.c.Marker({stx:this.stx,label:"trade",xPositioner:"date",x:a.DT,node:new r.c.Marker.Performance({type:"circle",category:"trade",displayCategory:!1,headline:"Executed at $"+a.Close,story:"Like all ChartIQ markers, the object itself is managed by the chart, so when you scroll the chart the object moves with you. It is also destroyed automatically for you when the symbol is changed."})})}};s.a},,function(e,t,a){"use strict";var o,r=a(1),n=a(2);"undefined"==typeof define&&"object"==typeof e?o=a(22):"function"==typeof define&&a(4)?define(["../../examples/markers/videoSample.css"],(function(e){o=e})):"undefined"!=typeof window&&r.c.loadStylesheet("examples/markers/videoSample.css"),r.c.activateImports(r.f),o&&r.c.addInternalStylesheet(o,"videoSample.css");const s=n.a.MarkersSample;function d({label:e,category:t,videoUrl:a}){const o=this.node=document.createElement("div");o.className="stx-marker square",t&&o.classList.add(t);const n=r.c.newChild(o,"div","stx-visual");r.c.newChild(o,"div","stx-stem");const s=function(e){const t=document.createElement("div");t.className="stx-marker-video stx-marker-expand";const a=document.createElement("div");a.className="ciq-icon ciq-close",t.appendChild(a);var o=document.createElement("video");o.canPlayType("video/mp4")&&o.setAttribute("src",e);/Edge/.test(navigator.userAgent)||o.setAttribute("controls","controls");return t.appendChild(o),t}(a);function d(){r.c.Marker.positionContentVerticalAndHorizontal(o)}o.append(s),r.c.safeClickTouch(o,(function({target:e}){const t=e===n,a=e.classList.contains("ciq-close");let r=o.classList.contains("highlight");const s=o.querySelector("video");if(t||a){if(o.classList.toggle("highlight"),r)return setTimeout(d,10),void s.pause();r=!r}s.firstClick||setTimeout(()=>{s.firstClick||(s.firstClick=!0,s.play())},100)}))}document.addEventListener("play",(function(e){const t=e.target;t.parentElement.style.zIndex=c++,Array.from(document.querySelectorAll("video")).filter(e=>e!==t).forEach(e=>e.pause())}),{capture:!0}),s.registerType("video","showVideoMarkers"),s.prototype.showVideoMarkers=function(e){const{stx:t}=this,{chart:a}=t,{dataSet:o,endPoints:n}=a;if(!o.length)return;const s=t.tickFromDate(n.end);return function(){const e="https://embed-ssl.wistia.com/deliveries/d1aa8163948cdcc3d01a0ccda618e4a91dbff03c.bin",t=[["video","Interview",e],["video","Utilizing Studies","https://embed-ssl.wistia.com/deliveries/3bebd8d93f5d1cd878e63037fc1294d7116d93e4.bin"],["video","Smart Zoom","https://embed-ssl.wistia.com/deliveries/68f205d2284792be162071c853c4af0a.bin"],["video","Drawing Tools","https://embed-ssl.wistia.com/deliveries/4048329c0ded7972445032db0372e0bdb268c78d.bin"],["video","Utilizing Studies","https://embed-ssl.wistia.com/deliveries/3bebd8d93f5d1cd878e63037fc1294d7116d93e4.bin"],["video","Time Span Events","https://embed-ssl.wistia.com/deliveries/46685ec00a9d3ab4bdcadd1391cf1f91.bin"],["video","Interview",e]];return new Promise((e,a)=>{e(t.map(([e,t,a])=>({category:e,headline:t,videoUrl:a})))})}().then(a=>{a.forEach(({category:a,headline:n,videoUrl:c},i)=>{const l=function(e){if(o[s-10*e-5])return o[s-10*e-5].DT}(i);if(void 0===l)return;const p={label:e,x:l,stx:t,xPositioner:"date",node:new d({x:l,label:e,category:a,headline:n,videoUrl:c,videoWidth:340})};new r.c.Marker(p)}),this.stx.draw()}),"video"},r.c.inheritsFrom(d,r.c.Marker.NodeCreator,!1);let c=400;n.a},,function(e,t,a){"use strict";var o=a(1);o.c.activateImports(o.e),o.c.I18N.languages={en:"English",ar:"عربى",fr:"Français",de:"Deutsche",hu:"Magyar",it:"Italiano",pt:"Português",ru:"русский",es:"Español",zh:"中文",ja:"日本語"},o.c.I18N.csv=o.c.I18N.hereDoc((function(e){
